...
module.exports = {
   ...
   */
     async registerEbUser(package) {
      ...
      switchToFrameAndType(this.elements.cardNumberFrame, this.elements.cardNumber, card.cardNumber);
      switchToFrameAndType(this.elements.cardExpDateFrame,this.elements.cardExpDate,`${card.expirationMonth}/${card.expirationYear.substr(2)}`);
      switchToFrameAndType(this.elements.cardCvcFrame, this.elements.cardCvc, card.cvv);
      switchToFrameAndType(this.elements.cardZipcodeFrame, this.elements.cardZipCode, card.postalCode);
      ...
      I.waitForText('Before submitting',20);
